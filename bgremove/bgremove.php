...
<head>
    ...
    <meta property="og:description" content="Remove backgrounds directly in your browser. 100% Free & Private.">
    ...
    <script type="application/ld+json">
    {
      ...
      "featureList": "Automatic Background Removal, On-Device Processing, Batch Processing"
    }
    </script>
    ...
    <style>
        ...
        .step-num { width: 28px; height: 28px; background: #6366f1; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; flex-shrink: 0; }
