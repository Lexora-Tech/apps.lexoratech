...
<body>
    ...
    <div id="helpModal">
        <div class="help-modal-content">
            ...
            <ul style="padding-left:20px; margin-top:15px; line-height:1.6;">
                ...
                <li><strong>Speed:</strong> After the first image, processing is instant.</li>
            </ul>
        </div>
    </div>
            ...
            <section class="workspace">
                ...
                <div id="dropZone" class="drop-zone">
                    <div class="zone-content">
                        ...
                        <button id="browseBtn" class="browse-btn"><i class="fas fa-folder-open"></i> Open File</button>
                    </div>
