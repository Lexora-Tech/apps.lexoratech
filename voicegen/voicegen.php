    ...
    <div class="app-shell">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <div class="control-section">
                    ...
                    <div class="range-group">
                        <div class="range-header">
                            <label>Speed</label>
                            <span id="rateValue" class="mono-tag">1.0x</span>
                        </div>
                    ...
                    <div class="range-group">
                        <div class="range-header">
                            <label>Pitch</label>
                            <span id="pitchValue" class="mono-tag">1.0</span>
                        </div>
                    ...
                    <div class="range-group">
                        <div class="range-header">
                            <label>Volume</label>
                            <span id="volValue" class="mono-tag">100%</span>
                        </div>
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        <span class="stat-title">CHARS</span>
        ...
        <main class="editor-canvas">
            ...
            <div class="text-area-wrapper">
                <textarea id="textInput" placeholder="Enter your script here... The AI will bring it to life."></textarea>
